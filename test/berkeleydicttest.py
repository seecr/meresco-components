...
class BerkeleyDictTestBase(SeecrTestCase):
    ...
    def testDelete(self):
        ...
        try:
            self.bdict[b'1']
            self.fail(b'must not come here')
        except KeyError:
            pass
    ...
    def testGet(self):
        ...
        self.assertEqual(b'some other string', self.bdict.get(b'1', b'something'))
        self.assertEqual(b'something', self.bdict.get(b'2', b'something'))
