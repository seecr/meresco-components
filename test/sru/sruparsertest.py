...
# Copyright (C) 2011-2012, 2018, 2020 Stichting Kennisnet https://www.kennisnet.nl
...
""", result)
    ...
    def _testValidateProperlyUTF8EncodedParameter(self):
        # py3: how to detect wrong encoding
